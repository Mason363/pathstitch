            ...
            VStack(alignment: .leading, spacing: 20) {
                ...
                Group {
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        shortcutRow("V", "Select tool")
                        shortcutRow("M", "Move tool")
                        shortcutRow("H", "Pan tool")
                        shortcutRow("O", "Offset tool")
                        shortcutRow("G", "Add Holes (sewing)")
                        shortcutRow("J", "Join / Cleanup")
                        shortcutRow("I", "Measure tool")
                        shortcutRow("D", "Dimension tool")
                        shortcutRow("L", "Draw line")
                        shortcutRow("C", "Draw circle")
                        shortcutRow("R", "Draw rectangle")
                        shortcutRow("P", "Pen tool")
                        shortcutRow("F", "Fillet corners")
                        shortcutRow("B", "Chamfer corners")
                        shortcutRow("E", "Convert Lines tool")
                        shortcutRow("T", "Trim tool")
                        shortcutRow("S", "Search / Command palette")
                    }
                }
